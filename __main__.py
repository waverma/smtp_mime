...
if __name__ == "__main__":
    ...
    # SMTPClient(args.user, args.to, args.subject, args.directory, args.ssl, args.server, args.auth, args.verbose, "C:\\Users\\Max\\Desktop\\хуилы.txt").run()
    file = open("C:\\Users\\Max\\Desktop\\Они.txt", "r", encoding='utf-8')
    for chmo in file.readlines():
        if chmo[-1] == "\n":
            chmo = chmo[:-1]
        SMTPClient("priem@urtisi.ru",
                   chmo,
                   "День Открытых Дверей",
                   "C:\\Users\\Max\\Desktop\\Он.txt",
                   True, "smtp.yandex.ru", True, False).run()
    file.close()
